...
//clcBtn.onclick = calcWakeUpTimes; line below this is general way of doing same thing
clcBtn.addEventListener("click", calcWakeUpTimes);
//passing fcn to another fcn; 

refreshBtn.addEventListener("click", calcWakeUpTimes);

//anonymous fcn example (that is passed in to addEventListener)
